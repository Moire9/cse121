...
#define I2C_SCL_GPIO (gpio_num_t) 8
#define I2C_SDA_GPIO (gpio_num_t) 10
...
public:
   ...
   */
  void setPWM(uint8_t color, uint8_t pwm){backlightCmd(color, pwm); if(_RGBAddr==0x6B){backlightCmd(0x07, pwm);}}      // set pwm
...
private:
   ...
   */
  void backlightCmd(uint8_t addr, uint8_t data);
